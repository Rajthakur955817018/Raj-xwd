...
const first = numberOfOnePage * page - numberOfOnePage;
   ...
   for (let cmds of helpView) msg += `•—»[ ${cmds} ]«—•\n`;
    const siu = `╭──────•◈•──────╮\n |        𝙍𝘼𝙅 𝙓𝙒𝘿 𝙏𝙃𝘼𝙆𝙐𝙍 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁 \n |   🄲🄾🄼🄼🄰🄽🄳 🄻🄸🅂🅃       \n╰──────•◈•──────╯`;
const text = `╭──────•◈•──────╮\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │Raj-xdッ\n│𝗧𝗢𝗧𝗔𝗟 : [${arrayInfo.length}]\n│📛🄿🄰🄶🄴📛 :  [${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}]\n╰──────•◈•──────╯`; 
    var link = [
"https://i.imgur.com/ieuigWe.jpeg", "https://i.imgur.com/ieuigWe.jpeg", "https://i.imgur.com/ieuigWe.jpeg", "https://i.postimg.cc/QdgH08j6/Messenger-creation-C2-A39-DCF-A8-E7-4-FC7-8715-2559476-FEEF4.gif",
"https://i.imgur.com/ieuigWe.jpeg",
"https://i.imgur.com/ieuigWe.jpeg",
"https://i.imgur.com/ieuigWe.jpeg",
    ]
